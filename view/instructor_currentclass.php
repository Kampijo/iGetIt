...
<nav>
    ...
    <h1>Class</h1>
        <fieldset>
            ...
            I Get It (<?php echo($positive) ?>%)<span style="background-color:green; width:<?php echo($positive) ?>%;"></span>
            I Don't Get It (<?php echo($negative) ?>%)<span style="background-color:red;  width:<?php echo($negative) ?>%;"></span>
        </fieldset>
<form method="post">
